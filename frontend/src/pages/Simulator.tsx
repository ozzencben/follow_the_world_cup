...
function BracketNode({
    ...
    return (
        <div
            className={`w-[190px] shrink-0 border-2 text-[10px] font-sans relative transition-all duration-150 select-none bg-zinc-950 ${match.isOverridden
                    ? "border-[#FFE600] shadow-[2.5px_2.5px_0px_#FFE600]"
                    : "border-zinc-800 hover:border-[#00E5FF] shadow-[2.5px_2.5px_0px_rgba(0,0,0,0.4)]"
                }`}
        >
            {/* Node Header */}
            <div className={`px-2 py-0.5 font-mono text-[8px] flex items-center justify-between border-b ${match.isOverridden ? "bg-[#FFE600] text-black font-black border-[#FFE600]" : "bg-zinc-900 text-zinc-500 border-zinc-800"
                }`}>
            ...
            {/* Node Body */}
            {isEditing ? (
                <form ref={formRef} onSubmit={handleSave} className="flex items-center justify-center space-x-1.5 p-2 bg-zinc-950 select-none">
                    <input
                        type="text"
                        inputMode="numeric"
                        pattern="[0-9]*"
                        ...
                        className="w-7 h-6 text-center bg-zinc-900 border border-zinc-800 text-white font-mono font-black text-[10px] focus:outline-none focus:border-[#00FF87]"
                    ...
                    <div className="bg-zinc-900 border-[3px] border-[#FFE600] p-6 relative overflow-hidden shadow-[6px_6px_0_#FFE600] space-y-4 animate-fade-up">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <button
                                ...
                                className={`swiss-btn-primary bg-[#FF2D78] hover:bg-[#D8105B] text-white border-black shadow-[3px_3px_0px_#FFE600] uppercase text-[10px] tracking-widest font-black flex items-center gap-2 px-5 py-3 cursor-pointer ${isPublishing ? "opacity-50 cursor-wait" : ""
                                    }`}
                            >
                                {isPublishing ? (
                                    <>
                                    ...
                                    {(Object.keys(STAGE_LABELS) as StageType[]).map((stage) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-4 py-2 text-[10px] font-black tracking-wider uppercase border-2 transition-all duration-150 relative cursor-pointer ${isActive
                                                ...
                                                {[
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`px-2.5 py-1 text-[9px] font-mono font-black border transition-all cursor-pointer ${isBtnActive
                                                ...
                                                {groups.map((g) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`w-7 h-7 flex items-center justify-center font-mono font-black text-xs border transition-all cursor-pointer ${isPillActive
                                    ...
                                    <div className="flex items-center justify-between border-b-2 border-zinc-900 pb-3 select-none">
                                        ...
                                        <div className="flex bg-zinc-950 p-1 border-2 border-black">
                                            <button
                                                ...
                                                className={`px-3 py-1.5 text-[9px] font-mono font-black uppercase tracking-widest transition-all cursor-pointer ${knockoutViewMode === "list"
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 text-[9px] font-mono font-black uppercase tracking-widest transition-all cursor-pointer ${knockoutViewMode === "bracket"
                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-1.5 text-[9px] font-black uppercase border-[2px] border-black tracking-wider transition-all duration-100 cursor-pointer ${isActive
                ...
                {[
                    ...
                    return (
                        <button
                            ...
                            className={`px-4 py-2.5 text-[10px] font-black uppercase border-[2px] border-black tracking-wider transition-all duration-100 cursor-pointer ${isActive
                                    ? "bg-zinc-800 text-white"
