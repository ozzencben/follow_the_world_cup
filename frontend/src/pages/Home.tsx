        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            ...
            <div className="space-y-3.5">
              {[
                { title: isTr ? "Durdurulamaz Dev & Ezici Aura" : "Unstoppable Giant & Supercharged Aura", desc: isTr ? "Baz ELO >= 1950 olan devlerin aurası, galibiyet serileriyle katlanarak rakibin gol beklentisini %45'e kadar (seriye göre) baskılar." : "Giants with base ELO >= 1950 emit a supercharged aura that dampens opponent expected goals by up to 45% based on win streak." },
                { title: isTr ? "Dinamik Turnuva Form Serileri" : "Dynamic Tournament Win Streaks", desc: isTr ? "Ardışık galibiyet alan takımlarda form patlaması. Standart ekiplerde +12 CSR (max +60 CSR), devlerde katlanarak +280 CSR'ye kadar momentum!" : "Successive wins generate form surges. Standard teams get +12 CSR per win (max +60), giants gain up to +280 CSR non-linear momentum!" },
