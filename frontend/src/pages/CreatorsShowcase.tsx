...
// ── HELPERS ───────────────────────────────────────────────────────
function Monogram({ name, hasPrediction }: { name: string; hasPrediction: boolean }) {
  const initials = name
    .split(" ")
    .map((w) => w[0])
    .join("")
  ...
  return (
    <div
      className="flex items-center justify-center font-black text-lg border-2 border-black shrink-0"
      style={{
        width: 52,
        height: 52,
        background: hasPrediction ? "#00FF87" : "#3f3f46",
        color: hasPrediction ? "#000" : "#71717a",
        boxShadow: hasPrediction ? "3px 3px 0px #000" : "3px 3px 0px #27272a",
      }}
    >
      {initials}
    </div>
...
function CreatorCard({
  ...
  return (
    <div
      className="relative bg-zinc-900 border-2 border-zinc-700 p-0 flex flex-col overflow-hidden transition-all duration-150"
      style={{
    ...
    >
      ...
      <div
        ...
        style={{ background: hasPrediction ? "#00FF87" : "#3f3f46" }}
      />
      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ...
            style={{
              color: hasPrediction ? "#00FF87" : "#52525b",
          ...
          {/* Avatar */}
          <Monogram name={creator.name} hasPrediction={hasPrediction} />
        ...
        {hasPrediction ? (
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 font-black text-xs tracking-widest text-black border-2 border-black uppercase transition-all duration-100 active:translate-x-[2px] active:translate-y-[2px]"
              style={{
                background: "#00FF87",
...
export default function CreatorsShowcase({
  ...
  return (
    <MainLayout currentRoute="creators" onRouteChange={onRouteChange}>
      <div className="space-y-10 max-w-5xl mx-auto">
        ...
        <div className="relative">
          ...
          <div
            className="absolute -top-4 left-0 text-[80px] md:text-[120px] font-black leading-none select-none pointer-events-none opacity-[0.03] tracking-tighter"
            style={{ color: "#00FF87" }}
          >
            EXPERTS
          </div>
        ...
        <div className="grid grid-cols-3 gap-0 border-2 border-zinc-800 overflow-hidden"
          ...
          {[
            ...
            <div
              key={label}
              className={`bg-black p-5 text-center ${i < 2 ? "border-r-2 border-zinc-800" : ""}`}
            >
              <div
              ...
              <div className="text-[8px] font-mono text-zinc-500 tracking-[0.2em] uppercase mt-2">
                {label}
              </div>
            </div>
          ))}
        ...
        {loading && creatorsList.length === 0 ? (
          ...
          <div
            className="border-2 border-dashed border-zinc-700 p-16 text-center"
            style={{ boxShadow: "5px 5px 0px #27272a" }}
          >
        ...
        {viewingCreatorName && (
          <div
            ...
            style={{
              background: "#00E5FF10",
              boxShadow: "4px 4px 0px #00E5FF40",
            }}
          >
            <span
        ...
        {/* ── FOOTER BAR ──────────────────────────────────────── */}
        <div
          className="border-t-2 border-zinc-800 pt-5 flex flex-col md:flex-row items-start md:items-center gap-3 justify-between"
        >
