...
export default function MatchCard({ match }: MatchCardProps) {
    ...
    return (
        <div
            className={`relative bg-zinc-900 border-2 select-none transition-all duration-200 ${match.isOverridden
                ...
                <div className="shrink-0 flex items-center justify-center px-2">
                    {isEditing ? (
                        ...
                        <div
                            ...
                            className={`flex items-center space-x-2 px-3 py-1.5 bg-zinc-950 border border-zinc-800 transition-colors ${isReadOnly
