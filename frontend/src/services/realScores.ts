...
export const REAL_SCORES: Record<string, RealScore> = {
    ...
    "saudiarabia-uruguay": { homeScore: 1, awayScore: 1 },
    ...
    // İsveç 5 - 1 Tunus
    "sweden-tunisia": { homeScore: 5, awayScore: 1 },
